...
void main(){
    vec3 lightVec = normalize(data.position - v_position);
    float value = max(0.0, dot(v_normal, lightVec));
...
const anotherLight = new PointLight(0x706f6f, 1.2)
anotherLight.position.add(new Vector3(3.1, 20, 100))
const mountainColor = new Color(0xFF0000);
const groundColor = new Color(0x008F00);
...
const mountainUniforms = {
    data: {
        value: {
            ...
            color: new Vector3(mountainColor.r, mountainColor.g, mountainColor.b)
        }
    }
};
...
const groundUniforms = {
    data: {
        value: {
            position: anotherLight.position,
            direction: new Vector3(0, 1, 0),
            color: new Vector3(groundColor.r, groundColor.g, groundColor.b)
        }
    }
};
// GLSL 
